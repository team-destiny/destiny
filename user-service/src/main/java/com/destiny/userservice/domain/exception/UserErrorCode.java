...
public enum UserErrorCode implements ResponseCode {
    ...
    INVALID_ADMIN_TOKEN(HttpStatus.UNAUTHORIZED, "USER-003", "관리자 토큰이 일치하지 않습니다."),
    INVALID_LOGIN_CREDENTIALS(HttpStatus.UNAUTHORIZED, "USER-004", "이메일 또는 비밀번호가 일치하지 않습니다.");
